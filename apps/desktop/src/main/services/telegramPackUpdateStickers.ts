...
import type { StickerSticker } from "./telegramPackMutationTypes";
...
export function assertTelegramMirrorHasStickers(
...
export async function ensureStickerFileExists(absolutePath: string, description: string) {
