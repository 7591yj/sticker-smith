...
import { TelegramMirrorService } from "./mirror/service";
import { TelegramPackMutationService } from "./pack/mutationService";
import { TelegramSecretsService } from "./secrets/service";
import { TelegramSyncService } from "./sync/service";
