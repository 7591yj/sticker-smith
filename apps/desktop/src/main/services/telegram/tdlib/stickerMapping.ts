import type { TelegramRemoteSticker, TelegramRemoteStickerSet } from "./types";
import { mapFile } from "./files";
import { asNumber, asPresentString, getObjectValue } from "./values";
